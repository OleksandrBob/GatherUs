...
namespace GatherUs.DAL.Migrations
{
    ...
    [Migration("20240414130203_FixedPaymentTransactionsTypes")]
    partial class FixedPaymentTransactionsTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GatherUs.DAL.Models.GatherUsPaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GatherUsPaymentTransactions");
                });
            ...
            modelBuilder.Entity("GatherUs.DAL.Models.GatherUsPaymentTransaction", b =>
                {
                    b.HasOne("GatherUs.DAL.Models.CustomEvent", "CustomEvent")
                        .WithOne()
                        .HasForeignKey("GatherUs.DAL.Models.GatherUsPaymentTransaction", "CustomEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GatherUs.DAL.Models.Guest", "Guest")
                        .WithOne()
                        .HasForeignKey("GatherUs.DAL.Models.GatherUsPaymentTransaction", "GuestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GatherUs.DAL.Models.Organizer", "Organizer")
                        .WithOne()
                        .HasForeignKey("GatherUs.DAL.Models.GatherUsPaymentTransaction", "OrganizerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
