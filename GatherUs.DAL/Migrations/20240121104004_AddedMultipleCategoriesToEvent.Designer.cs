...
namespace GatherUs.DAL.Migrations
{
    ...
    [Migration("20240121104004_AddedMultipleCategoriesToEvent")]
    partial class AddedMultipleCategoriesToEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomEventGuest", b =>
                {
                    b.Property<int>("AttendantsId")
                        .HasColumnType("integer");

                    b.Property<int>("PaidEventsId")
                        .HasColumnType("integer");

                    b.HasKey("AttendantsId", "PaidEventsId");

                    b.HasIndex("PaidEventsId");
            ...
            modelBuilder.Entity("GatherUs.DAL.Models.CustomEvent", b =>
                {
                    ...
                    b.Property<int>("CustomEventCategory")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CustomEventGuest", b =>
                {
                    b.HasOne("GatherUs.DAL.Models.Guest", null)
                        .WithMany()
                        .HasForeignKey("AttendantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GatherUs.DAL.Models.CustomEvent", null)
                        .WithMany()
                        .HasForeignKey("PaidEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
